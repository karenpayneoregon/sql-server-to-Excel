...
Public Class SqlServerOperations
    ...
    Public Function CountryList() As List(Of CountryItem)
        Dim country As New List(Of CountryItem)
        country.Add(New CountryItem With {.Name = "Select"})
        ...
        Using cn As New SqlConnection With {.ConnectionString = ConnectionString}
            Using cmd As New SqlCommand With {.Connection = cn}
                ...
                If reader.HasRows Then
                    While reader.Read
                        country.Add(New CountryItem With {.Name = reader.GetString(0)})
                    End While
                End If
            End Using
    ...
    Public Function ContactTitleList() As List(Of String)
        Dim titleList As New List(Of String) From {"Select"}
